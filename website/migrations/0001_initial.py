    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicine', models.CharField(blank=True, default='', max_length=256, null=True)),
                ('quantity', models.CharField(blank=True, default='', max_length=256, null=True)),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.doctordetails')),
